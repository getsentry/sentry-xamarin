...
* Update Sentry.NET SDK to 3.6.0 (#75) @lucas-zimerman
  - [changelog](https://github.com/getsentry/sentry-dotnet/blob/main/CHANGELOG.md#9)
  - [diff](https://github.com/getsentry/sentry-dotnet/compare/3.5.0...3.6.0)
